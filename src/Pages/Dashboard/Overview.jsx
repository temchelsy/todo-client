...
const TodoItem = ({ todo, onToggleCompletion, onDelete, onToggleSubtasks }) => {
  return (
    <li
...
const TodoStats = ({ remainingTodos, completedTodos, totalTodos }) => {
  return (
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      ...
      <TodoStats 
        ...
        completedTodos={completedTodosList.length} 
          ...
          <ul className="space-y-4">
            {todos.map((todo, index) => (
              <TodoItem 
                ...
                onToggleSubtasks={() => toggleSubtaskVisibility(index)}
              />
            ))}
          </ul>
        )}
